    ...
    <>
      <div className=" min-h-screen bg-[#1abc9c] flex justify-center items-center flex-col w-full">
        <div className="conatainer p-5 mx-auto">
          <div className="img w-64 mx-auto mb-3">
            <img src="src/img/images1.svg" className='w-full' alt="" />
          </div>
          <div className="special_title relative text-center ">
            <h1 className='lg:text-5xl text-3xl mx-auto w-fit relative  pb-5 mb-4 font-bold before:bg-white before:w-full before:absolute before:left-0 before:bottom-0 before:h-[6px] text-white'>START FRAMEWORK</h1>
          ...
          <div className="text mt-4  text-white flex flex-col lg:flex-row gap-5 justify-center items-center">
            <p className='max-w-[600px] '>     Graphic Artist - Web Designer - Illustrator
            </p>
          </div>
        </div>
